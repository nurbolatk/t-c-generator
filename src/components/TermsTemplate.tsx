  ...
  return (
    <div>
      ...
      <p>
        ...
        <strong>{data.name}</strong> does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of <strong>{data.name}</strong>, its agents
        ...
        laws, <strong>{data.name}</strong> shall not be liable for the Comments
      ...
      <p>
        <strong>{data.name}</strong> reserves the right to monitor all Comments
      ...
      <p>
        You hereby grant <strong>{data.name}</strong> a non-exclusive license to
      ...
      <p>
        ...
        e-mail to <strong>{data.name}</strong>. Please include your name, your
      ...
      <p>
        No use of <strong>{data.name}</strong>'s logo or other artwork will be
